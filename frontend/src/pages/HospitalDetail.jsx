    ...
    return (
        <div className="min-h-screen">
            ...
            <section className="mx-auto max-w-6xl px-6 pt-10 pb-20">
                ...
                <div className="mt-6 glass-mint rounded-3xl overflow-hidden">
                    <div className="h-56 relative">
                        ...
                        <div className="absolute bottom-5 left-6 right-6 text-white">
                            ...
                            <h1 className="editorial text-4xl mt-1">{hospital.name}</h1>
                        </div>
                    </div>
                ...
                <h2 className="editorial mt-10 text-3xl text-mint-800">Doctors at this hospital</h2>
                        ...
                        {doctors.map((d) => (
                            <Link key={d.id} to={`/doctors/${d.id}`}
                                ...
                                <div className="flex items-center gap-4">
                                    <img src={d.profile_photo_url} alt={d.name} className="h-16 w-16 rounded-xl object-cover" />
